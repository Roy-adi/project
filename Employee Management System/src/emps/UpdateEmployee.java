...
//            String education = tfeducation.getText();
            ...
            try {
                conn conn = new conn();
                String query = "update employee set father_name = '"+father_name+"', salary = '"+salary+"', address = '"+address+"', phone = '"+phone+"', email =  '"+email+"', designation = '"+designation+"' where empId = '"+empId+"'";
